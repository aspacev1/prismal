...
// "/api/invite" — unlike the page at "/invite" — is NOT a public path). If a
// future change ever adds a broader "/api/invite" prefix to PUBLIC_PATHS,
// that protection disappears silently — keep this route's exposure in mind
// if that happens.
